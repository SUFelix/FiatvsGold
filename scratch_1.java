...
class Scratch {
    ...
    //Damit dass Program funktioniert müssen die folgenden Pfade geändert werden
    static String leitzinsInputpath ="C:\\Users\\Felix\\Desktop\\Gold_Money_Projects\\leitzinsen.txt";
    static String goldpreisInputpath = "C:\\Users\\Felix\\Desktop\\Gold_Money_Projects\\goldpreise_in_euro.txt";
    static String gewinnOutputpath = "C:\\Users\\Felix\\Desktop\\Gold_Money_Projects\\data_out.txt";
    static String leitzinsOutputpath = "C:\\Users\\Felix\\Desktop\\Gold_Money_Projects\\ir_out.txt";

    public static final float bankenAufschlag = 2.0f;
    public static final float gelieheneEuros = 10000.0f;
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        *
        ...
        int i  =0;
        try {
            BufferedReader reader = new BufferedReader(new FileReader(goldpreisInputpath));
            String line = "";
        ...
        try{
            ...
            File file = new File(gewinnOutputpath);
            File file2 = new File(leitzinsOutputpath);
        ...
        catch(Exception e){System.out.println("Fehler beim schreiben");}
    ...
    public static float getiRate(Date date) throws IOException
    {
        ...
        BufferedReader reader = new BufferedReader(new FileReader(leitzinsInputpath));
        float lz  = 0.1f;
    ...
    public static float calcOneYearProfit(float goldpreis1,float goldpreis2,float iRate){
        ...
        float kapitalKostenInProzent = iRate+bankenAufschlag;
        float kapitalKosten = 0.01f*kapitalKostenInProzent*gelieheneEuros; // *0.01f um aus ganzen Prozent eine Dezimalzahl zu machen
        float wertDifferenz = (goldpreis2/goldpreis1)*gelieheneEuros; // Wert des Goldes nach einem Jahr
        float gewinn = wertDifferenz-kapitalKosten-gelieheneEuros;
        return gewinn;
    }

    //Es folgen drei kleine Helfer Methoden die dazu dienen die Verarbeitung mit Exel zu erleichtern
    ...
    //runden(String s) schneidet alle Nachkommastellen außer der ersten ab, da diese mehr Unübersichtlichkeit als Mehrwert beitragen
